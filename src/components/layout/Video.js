        ...
        <div className="main-container">
            <div className="main-section">
                    ...
                    <Link to={'/main-page'}>
                        ...
                        <li className="igloo-logo"><i className="fas fa-video"></i></li>
                        <li><img src={Image3} className="profile-image user-icon-alt" alt="profile"/></li>
                    </ul>

                
                    <h3>Fes clic a la icona de telèfon per a iniciar una videotrucada</h3>
                    ...
                    <div className="chat-section">
                        <h3>Videotrucades recents  <i className="title-icon fas fa-clock fa-sm"></i></h3> 
